...
/** send words to Microsoft translate API */
function sendWord( word ){
	...
	chrome.extension.sendRequest({name:'searchThis', message:word}, showBaloon);
	
	lastSearch = word;
}

function showBaloon( res ){
	bln_body.id = 'altrans_bln_show';
	bln_body.innerHTML = res
	adjustBaloonLoc();
}
